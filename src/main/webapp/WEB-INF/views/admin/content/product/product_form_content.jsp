...
<div class="container-fluid p-0">
	...
	<div class="mb-3">
		<h1 class="h3 d-inline align-middle">${product.productId == 0 ? 'Thêm sản phẩm' : 'Chỉnh sửa sản phẩm'}</h1>
				...
				<div class="col-lg-6">
					...
					<div class="mb-3">
						...
						<textarea class="form-control" id="productDes" rows="5"
							placeholder="Description" name="description" required>${product.description }
															</textarea>
					</div>
